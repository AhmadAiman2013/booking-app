...
export default function NewModalPage({ show, handleClose }) {
      ...
      <Modal.Body>
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group controlId="formDate">
            ...
            <br />
            <DatePicker selected={date} onChange={(date) => setDate(date)} dateFormat="dd/MM/yyyy" className="form-control" />
          </Form.Group>
          ...
          <Form.Group controlId="formPhoneNumber">
            ...
            <Form.Control type="tel" name="phoneNumber" value={phone} onChange={(e) => setPhone(e.target.value)} />
          </Form.Group>
